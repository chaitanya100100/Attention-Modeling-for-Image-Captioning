...
def main(args):
    ...
    decoder = DecoderRNNWithAttention(args.embed_size, args.attention_size, args.hidden_size, len(vocab))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--encoder_path', type=str, default='./coco_models/encoder-2-1000.ckpt', help='path for trained encoder')
    parser.add_argument('--decoder_path', type=str, default='./coco_models/decoder-2-1000.ckpt', help='path for trained decoder')
